...
def main() -> None:
    ...
    parser.add_argument("--output-dir", type=str, default=str(Path(__file__).parent / "output_lr"))
    ...
    plot_confusion_matrix(val_metrics["confusion_matrix"], output_dir / "val_confusion_matrix_lr.png",
                          "Validation Confusion Matrix")
    plot_confusion_matrix(test_metrics["confusion_matrix"], output_dir / "test_confusion_matrix_lr.png",
