...
def main(argv: list[str] | None = None) -> None:
    parser = argparse.ArgumentParser(description="Adaptive Routing Demo")
    parser.add_argument(
        "--output",
        default="adaptive_routing/demo_output.json",
        help="Path to write demo results as JSON (default: adaptive_routing/demo_output.json if relative).",
    )
