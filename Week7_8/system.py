...
from Week7_8.adaptive_router import AdaptiveRouter, RoutingConfig
from Week7_8.feature_encoder import SimpleRecordEncoder
from Week7_8.interfaces import Encryptor, ModelServerLike, RecordEncoder, SensitivityClassifierLike
    ...
    def __init__(
        ...
        *,
        ...
        if encryptor is None:
            raise ValueError(
                "IDSSystem 需要傳入一個真實的同態加密 encryptor（例如 Week6.PaillierEncryptor）。"
            )
