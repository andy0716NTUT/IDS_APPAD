...
class SimpleRecordEncoder:
    ...
    Why:
    - Week5 feature-sensitivity rules are key-name based (e.g., 'ip_address', 'location', 'timestamp').
    - Week6 protection expects those same keys to decide which fields go to HE.
